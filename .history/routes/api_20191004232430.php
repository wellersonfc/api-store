...
Route::namespace('API')->group(function(){
    Route::prefix('produtos')->group(function(){
        //Rota de Listanto todos os produtos
        ...
        //Rota de cadastro de produtos
        Route::post('/{id}','ProdutosController@update')->name('update_produtos');
        //Rota de cadastro de produtos
        Route::delete('/{id}','ProdutosController@delete')->name('update_produtos');
